package com.example.inviatoserver.Helper;
...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        if (buttonBuffer.containsKey(swipePosition))
            ...
            buttonList.clear();
        buttonBuffer.clear();
        swipeThreshold = 1.5f * buttonList.size() * buttonWidth;
        recoverSwipedItem();
    }//onSwiped
    ...
    public float getSwipeThreshold(float defaultValue) {
    ...
    public class MyButton {
        ...
        private IMyButtonClickListener listener;
        private Context context;
        private Resources resources;

        public MyButton(Context context, String text, int textSize, int imageResId, int color, IMyButtonClickListener listener) {
            this.text = text;
